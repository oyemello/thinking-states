...
function generateGeometricParticles(numParticles, r) {
  const particles = [];
...
export default function AsciiGeometricThinkingState({
  size = 80,
  color = '#006fcf',
  running = true,
  speedMultiplier = 1,
  ...
  const r = size * 0.40;
  const particles = useMemo(() => generateGeometricParticles(2500, r), [r]);
